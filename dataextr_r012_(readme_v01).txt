...
File: dataextr_r012_(readme_v01).txt                    {Modified: 05/14/20, Created: 11/22/19, Author: Bill Nunn}
...
Sample Data Files:
     ...
     # Sample "rows=<rows>" raw data file ($rows):            {Runs 03-04: Wine Industry Review}          {Data_Source: https://www.kaggle.com/zynicide/wine-reviews}
         ...
         *Notes: Raw "rows_wine_equ_3k" data source truncated using "<...>".  File "dataextr_r012_(rows_wine_equ_3k).txt" (3,022 rows) @ https://github.com/bluenunn/Toolchest/
