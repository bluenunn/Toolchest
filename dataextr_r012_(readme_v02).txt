...
Repository: https://github.com/bluenunn/Toolchest/
     ...
     - dataextr_r012_(docs_v02).txt                   {DataExtr Users Guide: "Option/Parm" definitions, RegEx support}

     - dataextr_r012_(readme_v02).txt                 {DataExtr Readme File: sample Syntax, Config, Data, Runs & History}
